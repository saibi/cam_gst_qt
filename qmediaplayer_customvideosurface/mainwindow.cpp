...
// use autovideosink for custom video surface

#if defined(__RK3399_X11__)
#define PIPELINE "gst-pipeline: rkisp device=/dev/video0 io-mode=1 analyzer=1 enable-3a=1 ! video/x-raw,format=NV12,width=800,height=480,framerate=30/1 ! videoconvert ! autovideosink name=qtvideosink"
	...
	ui(new Ui::MainWindow)
{
	...
	m_player->setVideoOutput(ui->widget_output->viewfinder());
